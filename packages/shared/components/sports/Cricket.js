...
const Bookmaker2 = lazy(() => import("./Bookmaker2"));
const CPLCupBookmaker = lazy(() => import("./CPLCupBookmaker"));
const MatchOdds = lazy(() => import("./MatchOdds"));

//todo: superover pending
const SuperOver = lazy(() => import("./SuperOver"));
const TiedMatch = lazy(() => import("./cricket/TiedMatch"));
const FancySession = lazy(() => import("./cricket/FancySession"));
const OverByOver = lazy(() => import("./cricket/OverByOver"));
const OddEven = lazy(() => import("./cricket/OddEven"));
const Fancy1 = lazy(() => import("./cricket/Fancy1"));
const Khado = lazy(() => import("./cricket/Khado"));
