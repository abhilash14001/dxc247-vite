...
export default function NavTabs() {
    return (
        ...
        <li className="nav-item">
          <Link className="nav-link" to="/game-list/cricket">
            Cricket
          </Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/game-list/tennis">
            Tennis
          </Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/game-list/soccer">
            Football
          </Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/game-list/table-tennis">
            Table Tennis
          </Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/casino/baccarat">
            Baccarat
          </Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/casino/card32">
            32 Cards
          </Link>
        </li>
      </ul>
