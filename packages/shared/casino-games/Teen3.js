...
const [playerA_Back, setPlayerA_Back] = useState(0);
    ...
    }, [exposure, sportLength, roundId, sportList, mybetModel.length]);
    ...
    // Helper function to find data in data.sub for Teen3
    const findDataInSub = (teamName, betType) => {
        if (!data || !data.sub) return null;

        // For Teen3, find the item by nat field
