            ...
            <div className="casino-video-cards">
                {showCardCount && (
                    <span className="text-white">
                        Next Card Count: 
                        <span className="text-warning"> {cardCount} / {cardCountName}</span>
                    </span>
                )}
                <div className="ab-cards-container">
                    ...
                    <div className="ms-4">
                        {data?.card && (
                            <AndarBaharVideoCards styles={{width: '100px'}} cards={data?.card} onlyHidePlayers={true}
                                                  player="Andar"/>
                        )}
                    </div>
                    <h5>Bahar</h5>
