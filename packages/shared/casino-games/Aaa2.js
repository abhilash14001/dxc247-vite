...
<div class="rules-section">
    ...
    const {getBalance} = useContext(AuthContext)
        ...
        const [playerStatuses, setPlayerStatuses] = useState({
            "Amar": 'suspended-box',
            "Akbar": 'suspended-box', 
            "Anthony": 'suspended-box',
            "Even": 'suspended-box',
            "Odd": 'suspended-box',
            "Red": 'suspended-box',
            "Black": 'suspended-box',
            "UNDER 7": 'suspended-box',
            "OVER 7": 'suspended-box'
        });
        ...
        // Helper function to find data in data.sub for Aaa2
        const findDataInSub = (teamName, betType) => {
            if (!data || !data.sub) return null;

            // For Aaa2, find the item by nat field
        ...
        return (
            ...
            <CasinoLayout ruleDescription={ruleDescription} raceClass="aaa" hideLoading={hideLoading} isBack={backOrLay}
                                ...
                                {Object.entries(totalPlayers).slice(0, 3).map(([index, value], i) => (
                                    <div className="casino-odd-box-container" key={i}>
                                        <div className="casino-nation-name">
                                            ...
                                            <div className="casino- d-md-none"></div>
                                        </div>
                                        <div
